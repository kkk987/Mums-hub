...
const ImpDocs = () => (
  <Section className="content">
    ...
    <p>Mums-hub is a website that is designed for informative purpose only.</p>
    
    <p>The contents of this website such as texts, graphics, images and other materials contained are for informational purpose only.
    ...
    <p>If you think you may have a medical emergency, call your doctor or dial 000 immediately. Mums-Hub does not recommend or endorse 
